...
# ── 2. Data paths ─────────────────────────────────────────────────────
TRAIN_DATA=${TRAIN_DATA:-"/mnt/moonfs/chenzhirong-b0/rllm-swe/data/swe_factory_1000.parquet"}
VAL_DATA=${VAL_DATA:-"/mnt/moonfs/chenzhirong-b0/rllm-swe/data/swe_factory_1000.parquet"}
...
python3 -m rllm.trainer.verl.train_agent_ppo \
    ...
    trainer.default_local_dir=/mnt/moonfs/chenzhirong-b0/rllm-swe/checkpoints/test_rllm \
